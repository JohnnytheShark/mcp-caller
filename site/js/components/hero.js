...
export function renderHero(containerId = 'hero-container') {
      ...
      <div class="container">
        <div class="hero-layout">
          <div class="hero-text">
            ...
            <h1 class="hero-title">
              The interactive CLI for the <span class="title-accent">AI agents</span>
            </h1>

            <p class="hero-subtitle">
              A lightweight CLI tool to discover, inspect, and invoke Model Context Protocol (MCP) server tools directly from your terminal—without an LLM. Features an interactive schema-prompting wizard and headless automation.
            </p>
            ...
            <div class="hero-stats">
              ...
              <div class="stat-item">
                <span class="stat-value">v2024-11-05</span>
                <span class="stat-label">Protocol Spec</span>
              </div>
            </div>
          </div>
  ...
  const commands = {
    'curl-sh': 'curl -fsSL https://raw.githubusercontent.com/JohnnytheShark/mcp-caller/main/install.sh | bash',
    'powershell': 'irm https://raw.githubusercontent.com/JohnnytheShark/mcp-caller/main/install.ps1 | iex',
    'cargo': 'cargo install mcp-caller'
  };
